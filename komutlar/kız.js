...
exports.run = async (client, message, args) => {
...

 {
  ...
  if(!isimler) {
          ...
          .setDescription("<a:westa_tik:857585593152438343> <@"+member+"> üyesi başarıyla kız olarak kayıt edildi.")
          .setColor("RANDOM")
