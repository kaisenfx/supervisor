...
exports.run = (client, message, args) => {
  if(!message.member.roles.cache.has("845953394825101312") && !message.member.hasPermission("ADMINISTRATOR"))
    return message.channel.send(
      "<a:arsela_onaysiz:845952031767920651>  Bu komutu kullanabilmek için `Emojileri yönet` yetkisine sahip olmalısınız"
    );
  let link = args[0];
  let isim = args[1];
