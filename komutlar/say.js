...
module.exports.run = async (client, message, args) => {
  ...
  if(!["857565760237994024"].some(role => message.member.roles.cache.get(role)) && (!message.member.hasPermission("ADMINISTRATOR"))) 
...
return {
    ...
    '9': (client.config.sayı9)}[d];})}
         ...
         const embed1 = new Discord.MessageEmbed()
            ...
            .setDescription(`<a:westa_sariyildiz:857908993175453707> Sunucuda toplam **${toplamuye}** üye bulunmakta.
            <a:westa_sariyildiz:857908993175453707> Sunucuda **${cevirimici}** aktif üye bulunmakta.
            <a:westa_sariyildiz:857908993175453707> Sunucuda toplam tagımızı alan **${taglılar}** üye bulunmakta.
            <a:westa_sariyildiz:857908993175453707> Sunucuda sesli sohbetlerde toplam **${sessayı}** üye bulunmakta`)
